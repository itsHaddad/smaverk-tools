...
if (!(await p.evaluate(() => typeof window.__vert?.setLicensed === "function"))) {
  ...
  check(false, "this tool exposes no way to force the paid state (window.__vert.setLicensed), so the paid panel cannot be audited");
} else {
  try {
